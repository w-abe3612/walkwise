...
"""STEP4 typed source scaffold for script/persistence/unit_of_work.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-DB-002', 'SqliteUnitOfWork', 'context managerでcommit/rollbackし各Repositoryを共有接続へ束ねる。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/persistence/unit_of_work.py)")
