...
"""STEP4 typed source scaffold for script/schemas/source_metadata.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-SOURCE-001', 'SourceMetadata.from_file(...) -> SourceMetadata', 'media type、相対path、hash、状態を保持する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/schemas/source_metadata.py)")
...
class SourceMetadata:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        self._args = args
        self._kwargs = kwargs
    def from_file(self, *args: Any, **kwargs: Any) -> SourceMetadata:
        """media type、相対path、hash、状態を保持する。

        Public contract: ``SourceMetadata.from_file(...) -> SourceMetadata``.
        """
        _step4_unimplemented('SourceMetadata.from_file')
