...
"""STEP4 typed source scaffold for script/schemas/source_review.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-SOURCE-003', 'SourceReviewIssue/CorrectionPatch/ReviewDecision', '問題、修正差分、人間判断を型付けする。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/schemas/source_review.py)")
