...
"""STEP4 typed source scaffold for script/schemas/profiles.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-PROFILE-001', 'CharacterProfile/VoiceProfile/EngineIdentity', '内部IDと外部engine IDを分離する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/schemas/profiles.py)")
