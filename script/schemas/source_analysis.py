...
"""STEP4 typed source scaffold for script/schemas/source_analysis.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-AI-003', 'SourceSummary/TopicIndex/CoverageMap/SourceRequirement', '資料分析成果物を型付けする。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/schemas/source_analysis.py)")
