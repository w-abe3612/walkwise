...
"""STEP4 typed source scaffold for script/worker/protocol.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-WORKER-001', 'WorkerRequest/WorkerEvent/WorkerError', 'JSON Linesのrequest/result/progress/artifact/errorを型付けする。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/worker/protocol.py)")
