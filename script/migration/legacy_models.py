...
"""STEP4 typed source scaffold for script/migration/legacy_models.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-MIGRATION-001', 'LegacyBook/LegacySection/LegacyAudioInput', '旧book.json、sections.json等を型付けする。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/migration/legacy_models.py)")
