...
"""STEP4 typed source scaffold for script/ai_clients/registry.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-AI-001', 'AIClientRegistry.register/get', 'provider名でadapterを選択する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/ai_clients/registry.py)")
...
class AIClientRegistry:
    ...
    def register(self) -> Any:
        """provider名でadapterを選択する。

        Public contract: ``AIClientRegistry.register/get``.
        """
        _step4_unimplemented('AIClientRegistry.register')
    def get(self) -> Any:
        """provider名でadapterを選択する。

        Public contract: ``AIClientRegistry.register/get``.
        """
        _step4_unimplemented('AIClientRegistry.get')
