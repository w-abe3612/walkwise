...
"""STEP4 typed source scaffold for script/tts_clients/registry.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-TTS-001', 'TTSClientRegistry.register/get', 'engine名でclientを選択し未知engineを拒否する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/tts_clients/registry.py)")
...
class TTSClientRegistry:
    ...
    def register(self) -> Any:
        """engine名でclientを選択し未知engineを拒否する。

        Public contract: ``TTSClientRegistry.register/get``.
        """
        _step4_unimplemented('TTSClientRegistry.register')
    def get(self) -> Any:
        """engine名でclientを選択し未知engineを拒否する。

        Public contract: ``TTSClientRegistry.register/get``.
        """
        _step4_unimplemented('TTSClientRegistry.get')
