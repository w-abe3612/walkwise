...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-COEIR-001', 'CoeiroinkHttpClient.check_connectivity/list_speakers/synthesize', '公式確認後にのみ具体endpointを固定する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/tts_clients/coeiroink/client.py)")

class CoeiroinkHttpClient:
    """Public service/adapter scaffold fixed by STEP2."""
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        self._args = args
        self._kwargs = kwargs
    def check_connectivity(self) -> Any:
        """公式確認後にのみ具体endpointを固定する。

        Public contract: ``CoeiroinkHttpClient.check_connectivity/list_speakers/synthesize``.
        """
        _step4_unimplemented('CoeiroinkHttpClient.check_connectivity')
    def list_speakers(self) -> Any:
        """公式確認後にのみ具体endpointを固定する。

        Public contract: ``CoeiroinkHttpClient.check_connectivity/list_speakers/synthesize``.
        """
        _step4_unimplemented('CoeiroinkHttpClient.list_speakers')
    def synthesize(self) -> Any:
        """公式確認後にのみ具体endpointを固定する。

        Public contract: ``CoeiroinkHttpClient.check_connectivity/list_speakers/synthesize``.
        """
        _step4_unimplemented('CoeiroinkHttpClient.synthesize')
