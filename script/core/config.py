...
"""STEP4 typed source scaffold for script/core/config.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-CORE-001', 'AppConfig.load(env: Mapping[str, str]', 'None = None) -> AppConfig`'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/core/config.py)")
