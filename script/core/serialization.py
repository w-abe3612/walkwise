...
"""STEP4 typed source scaffold for script/core/serialization.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-CORE-002', 'load_yaml/load_json/dump_yaml/dump_json', '安全なUTF-8読み書きとschema version検証を提供する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/core/serialization.py)")

def load_yaml() -> Any:
    """安全なUTF-8読み書きとschema version検証を提供する。

    Public contract: ``load_yaml/load_json/dump_yaml/dump_json``.
    """
    _step4_unimplemented('load_yaml')
...
def load_json() -> Any:
    ...
    Public contract: ``load_yaml/load_json/dump_yaml/dump_json``.
    """
    _step4_unimplemented('load_json')
...
def dump_yaml() -> Any:
    ...
    Public contract: ``load_yaml/load_json/dump_yaml/dump_json``.
    """
    _step4_unimplemented('dump_yaml')
...
def dump_json() -> Any:
    ...
    Public contract: ``load_yaml/load_json/dump_yaml/dump_json``.
    """
    _step4_unimplemented('dump_json')
