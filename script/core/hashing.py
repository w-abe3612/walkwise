...
"""STEP4 typed source scaffold for script/core/hashing.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-CORE-002', 'canonical_sha256(value: JsonValue, *, excluded_keys: Collection[str] = ...) -> str', 'NFC・LF・key順を正規化しSHA-256を返す。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/core/hashing.py)")
...
def canonical_sha256(value: JsonValue, *, excluded_keys: Collection[str] = None) -> str:
    """NFC・LF・key順を正規化しSHA-256を返す。

    Public contract: ``canonical_sha256(value: JsonValue, *, excluded_keys: Collection[str] = ...) -> str``.
    """
    _step4_unimplemented('canonical_sha256')
