...
"""STEP4 typed source scaffold for script/ai/budget.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-AI-002', 'BudgetGuard.reserve/record/assert_available', 'API呼出し前に予算を判定しusageを記録する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/ai/budget.py)")
...
class BudgetGuard:
    ...
    def reserve(self) -> Any:
        """API呼出し前に予算を判定しusageを記録する。

        Public contract: ``BudgetGuard.reserve/record/assert_available``.
        """
        _step4_unimplemented('BudgetGuard.reserve')
    def record(self) -> Any:
        """API呼出し前に予算を判定しusageを記録する。

        Public contract: ``BudgetGuard.reserve/record/assert_available``.
        """
        _step4_unimplemented('BudgetGuard.record')
    def assert_available(self) -> Any:
        """API呼出し前に予算を判定しusageを記録する。

        Public contract: ``BudgetGuard.reserve/record/assert_available``.
        """
        _step4_unimplemented('BudgetGuard.assert_available')
