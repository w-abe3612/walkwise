...
"""STEP4 typed source scaffold for script/ai/cache.py.
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-AI-002', 'AICache.get/put(key, result)', 'task/model/prompt/input hashで再利用する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (script/ai/cache.py)")
...
class AICache:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._kwargs = kwargs
    def get(self) -> Any:
        """task/model/prompt/input hashで再利用する。

        Public contract: ``AICache.get/put(key, result)``.
        """
        _step4_unimplemented('AICache.get')
    def put(self, key: Any, result: Any) -> Any:
        """task/model/prompt/input hashで再利用する。

        Public contract: ``AICache.get/put(key, result)``.
        """
        _step4_unimplemented('AICache.put')
