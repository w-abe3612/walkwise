...
@pytest.mark.xfail(strict=True, reason="STEP3 scaffold: TC-RELEASE-002-02 is not implemented")
def test_tc_release_002_02() -> None:
    ...
    pytest.fail("STEP3 scaffold not implemented: TC-RELEASE-002-02")

@pytest.mark.unit
@pytest.mark.xfail(strict=True, reason="STEP3 scaffold: TC-RELEASE-002-04 is not implemented")
def test_tc_release_002_04() -> None:
    """TC-RELEASE-002-04 — 性能基準の測定記録
    
    Contract: docs/test-cases/TASK-RELEASE-002-performance-resilience-and-release-acceptance.md
    Priority: P1
    Layer: unit
    Given: 承認済み仕様に適合する最小入力と、必要な依存をmockした状態
    When: `performance scenarios`を通じて「性能基準の測定記録」を実行する
    Then: 「性能基準の測定記録」の承認済み仕様を満たし、戻り値・永続化・eventが再実行可能かつ決定的である。
    ...
    - Preserve this case ID, layer, Given/When/Then, and strict xfail
    until the intended Red state has been demonstrated."""
    pytest.fail("STEP3 scaffold not implemented: TC-RELEASE-002-04")

@pytest.mark.unit
@pytest.mark.xfail(strict=True, reason="STEP3 scaffold: TC-RELEASE-002-06 is not implemented")
def test_tc_release_002_06() -> None:
    ...
    Layer: unit
    Given: 承認済み仕様に適合する最小入力と、必要な依存をmockした状態
    When: `performance scenarios`を通じて「cancel/restart」を実行する
    ...
    - Preserve this case ID, layer, Given/When/Then, and strict xfail
    until the intended Red state has been demonstrated."""
    pytest.fail("STEP3 scaffold not implemented: TC-RELEASE-002-06")

@pytest.mark.unit
@pytest.mark.xfail(strict=True, reason="STEP3 scaffold: TC-RELEASE-002-08 is not implemented")
def test_tc_release_002_08() -> None:
    """TC-RELEASE-002-08 — 必須入力欠落
    
    Contract: docs/test-cases/TASK-RELEASE-002-performance-resilience-and-release-acceptance.md
    Priority: P0
    Layer: unit
    Given: 主ID、必須path、必須設定のいずれかが欠落した入力
    When: `performance scenarios`を実行する
    ...
    - Preserve this case ID, layer, Given/When/Then, and strict xfail
    until the intended Red state has been demonstrated."""
    pytest.fail("STEP3 scaffold not implemented: TC-RELEASE-002-08")

@pytest.mark.unit
@pytest.mark.xfail(strict=True, reason="STEP3 scaffold: TC-RELEASE-002-10 is not implemented")
def test_tc_release_002_10() -> None:
    """TC-RELEASE-002-10 — 入力・既存成果物の不変性
    ...
    - Preserve this case ID, layer, Given/When/Then, and strict xfail
    until the intended Red state has been demonstrated."""
    pytest.fail("STEP3 scaffold not implemented: TC-RELEASE-002-10")
...
STEP4_PUBLIC_CONTRACTS: tuple[tuple[str, str, str], ...] = (
    ('TASK-RELEASE-002', 'resilience scenarios', 'disk full、DB破損、強制終了、部分失敗から復旧する。'),
)
...
def _step4_unimplemented(symbol: str) -> None:
    raise NotImplementedError(f"STEP4 source scaffold is not implemented: {symbol} (tests/resilience/test_failure_recovery.py)")
