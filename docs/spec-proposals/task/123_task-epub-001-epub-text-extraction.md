...
depends_on:
  ...
  - "TASK-SOURCE-002"
spec_refs:
  - ../../specifications/epub-text-extraction.md
  - ../../specifications/19-application-scope-and-mvp.md
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-EPUB-001-epub-text-extraction.md"
  executable_task: "docs/tasks/TASK-EPUB-001-epub-text-extraction.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-EPUB-001-epub-text-extraction.md`で具体化する。
...
```text
docs/tasks/TASK-EPUB-001-epub-text-extraction.md
```
