...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-CLAIM-001-claims-evidence-and-fact-checking.md"
  executable_task: "docs/tasks/TASK-CLAIM-001-claims-evidence-and-fact-checking.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-CLAIM-001-claims-evidence-and-fact-checking.md`で具体化する。
...
```text
docs/tasks/TASK-CLAIM-001-claims-evidence-and-fact-checking.md
```
