...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-ARTIFACT-001-artifact-registry-and-versioning.md"
  executable_task: "docs/tasks/TASK-ARTIFACT-001-artifact-registry-and-versioning.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-ARTIFACT-001-artifact-registry-and-versioning.md`で具体化する。
...
```text
docs/tasks/TASK-ARTIFACT-001-artifact-registry-and-versioning.md
```
