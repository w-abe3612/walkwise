...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-OCR-001-ocr-and-scanned-pdf-processing.md"
  executable_task: "docs/tasks/TASK-OCR-001-ocr-and-scanned-pdf-processing.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-OCR-001-ocr-and-scanned-pdf-processing.md`で具体化する。
...
```text
docs/tasks/TASK-OCR-001-ocr-and-scanned-pdf-processing.md
```
