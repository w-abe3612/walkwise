...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-UI-003-build-settings-and-voice-preview-screen.md"
  executable_task: "docs/tasks/TASK-UI-003-build-settings-and-voice-preview-screen.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-UI-003-build-settings-and-voice-preview-screen.md`で具体化する。
...
```text
docs/tasks/TASK-UI-003-build-settings-and-voice-preview-screen.md
```
