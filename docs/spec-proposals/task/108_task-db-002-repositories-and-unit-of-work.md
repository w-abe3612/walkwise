...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-DB-002-repositories-and-unit-of-work.md"
  executable_task: "docs/tasks/TASK-DB-002-repositories-and-unit-of-work.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-DB-002-repositories-and-unit-of-work.md`で具体化する。
...
```text
docs/tasks/TASK-DB-002-repositories-and-unit-of-work.md
```
