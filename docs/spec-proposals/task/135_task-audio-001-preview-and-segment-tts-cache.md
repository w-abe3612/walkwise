...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-AUDIO-001-preview-and-segment-tts-cache.md"
  executable_task: "docs/tasks/TASK-AUDIO-001-preview-and-segment-tts-cache.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-AUDIO-001-preview-and-segment-tts-cache.md`で具体化する。
...
```text
docs/tasks/TASK-AUDIO-001-preview-and-segment-tts-cache.md
```
