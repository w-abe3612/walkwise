...
status: draft
order: 126
implementation_task_id: "TASK-AI-003"
...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-AI-003-source-analysis-and-coverage.md"
  executable_task: "docs/tasks/TASK-AI-003-source-analysis-and-coverage.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-AI-003-source-analysis-and-coverage.md`で具体化する。
...
```text
docs/tasks/TASK-AI-003-source-analysis-and-coverage.md
```
