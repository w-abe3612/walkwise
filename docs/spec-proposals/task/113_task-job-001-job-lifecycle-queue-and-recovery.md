...
spec_refs:
  ...
  - ../../db/04-jobs-table.md
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-JOB-001-job-lifecycle-queue-and-recovery.md"
  executable_task: "docs/tasks/TASK-JOB-001-job-lifecycle-queue-and-recovery.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-JOB-001-job-lifecycle-queue-and-recovery.md`で具体化する。
...
```text
docs/tasks/TASK-JOB-001-job-lifecycle-queue-and-recovery.md
```
