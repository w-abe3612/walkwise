...
depends_on:
  - "TASK-AUDIO-003"
spec_refs:
  - ../../specifications/m4b-output.md
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-M4B-001-m4b-output.md"
  executable_task: "docs/tasks/TASK-M4B-001-m4b-output.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-M4B-001-m4b-output.md`で具体化する。
...
```text
docs/tasks/TASK-M4B-001-m4b-output.md
```
