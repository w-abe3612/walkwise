...
depends_on:
  ...
  - "TASK-MIGRATION-001"
spec_refs:
  - ../../spec-proposals/task/1_sample-book-end-to-end-validation.md
  - ../../specifications/audiobook-creation-pipeline.md
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-E2E-001-sample-book-fixtures-and-acceptance.md"
  executable_task: "docs/tasks/TASK-E2E-001-sample-book-fixtures-and-acceptance.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-E2E-001-sample-book-fixtures-and-acceptance.md`で具体化する。
...
```text
docs/tasks/TASK-E2E-001-sample-book-fixtures-and-acceptance.md
```
