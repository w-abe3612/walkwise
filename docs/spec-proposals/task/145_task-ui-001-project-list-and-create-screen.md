...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-UI-001-project-list-and-create-screen.md"
  executable_task: "docs/tasks/TASK-UI-001-project-list-and-create-screen.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-UI-001-project-list-and-create-screen.md`で具体化する。
...
```text
docs/tasks/TASK-UI-001-project-list-and-create-screen.md
```
