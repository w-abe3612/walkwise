...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-PDF-001-pdf-direct-text-extraction.md"
  executable_task: "docs/tasks/TASK-PDF-001-pdf-direct-text-extraction.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-PDF-001-pdf-direct-text-extraction.md`で具体化する。
...
```text
docs/tasks/TASK-PDF-001-pdf-direct-text-extraction.md
```
