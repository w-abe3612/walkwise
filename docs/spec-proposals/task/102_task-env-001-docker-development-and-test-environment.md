...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-ENV-001-docker-development-and-test-environment.md"
  executable_task: "docs/tasks/TASK-ENV-001-docker-development-and-test-environment.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-ENV-001-docker-development-and-test-environment.md`で具体化する。
...
```text
docs/tasks/TASK-ENV-001-docker-development-and-test-environment.md
```
