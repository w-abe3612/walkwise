...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-APPROVAL-001-approval-workflow-and-invalidation.md"
  executable_task: "docs/tasks/TASK-APPROVAL-001-approval-workflow-and-invalidation.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-APPROVAL-001-approval-workflow-and-invalidation.md`で具体化する。
...
```text
docs/tasks/TASK-APPROVAL-001-approval-workflow-and-invalidation.md
```
