...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-CURRICULUM-001-curriculum-and-chapter-spec-generation.md"
  executable_task: "docs/tasks/TASK-CURRICULUM-001-curriculum-and-chapter-spec-generation.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-CURRICULUM-001-curriculum-and-chapter-spec-generation.md`で具体化する。
...
```text
docs/tasks/TASK-CURRICULUM-001-curriculum-and-chapter-spec-generation.md
```
