...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-UI-002-source-workspace-review-and-approval.md"
  executable_task: "docs/tasks/TASK-UI-002-source-workspace-review-and-approval.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-UI-002-source-workspace-review-and-approval.md`で具体化する。
...
```text
docs/tasks/TASK-UI-002-source-workspace-review-and-approval.md
```
