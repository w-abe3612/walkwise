...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-AUDIO-003-chapter-packaging-manifests-and-build-orchestration.md"
  executable_task: "docs/tasks/TASK-AUDIO-003-chapter-packaging-manifests-and-build-orchestration.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-AUDIO-003-chapter-packaging-manifests-and-build-orchestration.md`で具体化する。
...
```text
docs/tasks/TASK-AUDIO-003-chapter-packaging-manifests-and-build-orchestration.md
```
