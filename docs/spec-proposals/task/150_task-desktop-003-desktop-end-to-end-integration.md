...
planned_outputs:
  test_case_contract: "docs/test-cases/TASK-DESKTOP-003-desktop-end-to-end-integration.md"
  executable_task: "docs/tasks/TASK-DESKTOP-003-desktop-end-to-end-integration.md"
  test_scaffolds:
...
次の事項を`docs/test-cases/TASK-DESKTOP-003-desktop-end-to-end-integration.md`で具体化する。
...
```text
docs/tasks/TASK-DESKTOP-003-desktop-end-to-end-integration.md
```
