...
depends_on:
- TASK-CORE-002
contract_ref: docs/test-cases/TASK-PROFILE-001-character-and-voice-profiles.md
preparation_ref: docs/spec-proposals/task/130_task-profile-001-character-and-voice-profiles.md
spec_refs:
...
1. 承認済み仕様・DB・画面文書
2. `docs/test-cases/TASK-PROFILE-001-character-and-voice-profiles.md`
