...
- TASK-IMAGE-002
- TASK-PDF-001
contract_ref: docs/test-cases/TASK-OCR-001-ocr-and-scanned-pdf-processing.md
preparation_ref: docs/spec-proposals/task/120_task-ocr-001-ocr-and-scanned-pdf-processing.md
spec_refs:
...
1. 承認済み仕様・DB・画面文書
2. `docs/test-cases/TASK-OCR-001-ocr-and-scanned-pdf-processing.md`
