...
depends_on:
- TASK-DEV-001
contract_ref: docs/test-cases/TASK-CORE-001-configuration-errors-and-logging.md
preparation_ref: docs/spec-proposals/task/103_task-core-001-configuration-errors-and-logging.md
spec_refs:
...
1. 承認済み仕様・DB・画面文書
2. `docs/test-cases/TASK-CORE-001-configuration-errors-and-logging.md`
