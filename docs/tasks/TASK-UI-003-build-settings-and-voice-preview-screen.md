...
- TASK-BUILD-001
- TASK-AUDIO-001
contract_ref: docs/test-cases/TASK-UI-003-build-settings-and-voice-preview-screen.md
preparation_ref: docs/spec-proposals/task/147_task-ui-003-build-settings-and-voice-preview-screen.md
spec_refs:
...
1. 承認済み仕様・DB・画面文書
2. `docs/test-cases/TASK-UI-003-build-settings-and-voice-preview-screen.md`
...
```powershell
npm test -- electron/tests/build_voice_ipc.test.ts electron/renderer/tests/BuildSettings.test.ts
```
