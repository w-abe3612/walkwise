...
depends_on:
- TASK-INGEST-001
contract_ref: docs/test-cases/TASK-PDF-001-pdf-direct-text-extraction.md
preparation_ref: docs/spec-proposals/task/119_task-pdf-001-pdf-direct-text-extraction.md
spec_refs:
...
1. 承認済み仕様・DB・画面文書
2. `docs/test-cases/TASK-PDF-001-pdf-direct-text-extraction.md`
