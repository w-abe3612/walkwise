/** STEP4 typed source scaffold for electron/renderer/api/projects.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-UI-001", symbol: "listProjects/createProject", contract: "preload API\u3092\u578b\u4ed8\u304d\u3067\u547c\u3076\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/renderer/api/projects.ts)`);
}

export async function listProjects(..._args: readonly unknown[]): Promise<unknown> {
  return step4Unimplemented("listProjects");
}

export async function createProject(..._args: readonly unknown[]): Promise<unknown> {
  return step4Unimplemented("createProject");
}
