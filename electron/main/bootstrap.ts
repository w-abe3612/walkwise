/** STEP4 typed source scaffold for electron/main/bootstrap.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-DESKTOP-002", symbol: "bootstrapApplication(): Promise<AppContext>", contract: "data root\u3001DB migration\u3001worker health\u3092\u9806\u5e8f\u3069\u304a\u308a\u521d\u671f\u5316\u3059\u308b\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/main/bootstrap.ts)`);
}

export async function bootstrapApplication(..._args: readonly unknown[]): Promise<unknown> {
  return step4Unimplemented("bootstrapApplication");
}
