/** STEP4 typed source scaffold for electron/main/index.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-DESKTOP-001", symbol: "createMainWindow(): BrowserWindow", contract: "\u5b89\u5168\u306awebPreferences\u3067renderer\u3092\u8d77\u52d5\u3059\u308b\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/main/index.ts)`);
}

export async function createMainWindow(..._args: readonly unknown[]): Promise<unknown> {
  return step4Unimplemented("createMainWindow");
}
