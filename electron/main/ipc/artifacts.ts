/** STEP4 typed source scaffold for electron/main/ipc/artifacts.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-UI-004", symbol: "artifact:list/open-folder handlers", contract: "\u76f8\u5bfepath\u3092\u691c\u8a3c\u3057\u3066OS\u3078\u59d4\u8b72\u3059\u308b\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/main/ipc/artifacts.ts)`);
}

export function registerArtifactIpcHandlers(..._args: readonly unknown[]): unknown {
  return step4Unimplemented("registerArtifactIpcHandlers");
}
