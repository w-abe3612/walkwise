/** STEP4 typed source scaffold for electron/main/ipc/builds.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-UI-003", symbol: "build-request:create/job:start handlers", contract: "\u51fa\u529b\u5f62\u5f0f\u3068voice\u6761\u4ef6\u3001approval gate\u3092\u691c\u8a3c\u3059\u308b\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/main/ipc/builds.ts)`);
}

export function registerBuildIpcHandlers(..._args: readonly unknown[]): unknown {
  return step4Unimplemented("registerBuildIpcHandlers");
}
