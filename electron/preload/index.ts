/** STEP4 typed source scaffold for electron/preload/index.ts.
...
export const STEP4_PUBLIC_CONTRACTS: readonly Step4ContractEntry[] = [
  { taskId: "TASK-DESKTOP-001", symbol: "window.walkwise API", contract: "\u8a31\u53ef\u6e08\u307fIPC\u3060\u3051\u3092\u578b\u4ed8\u304d\u3067\u516c\u958b\u3059\u308b\u3002" },
];
...
function step4Unimplemented(symbol: string): never {
  throw new Error(`STEP4 source scaffold is not implemented: ${symbol} (electron/preload/index.ts)`);
}

export class window {
  constructor(..._args: readonly unknown[]) {}
  walkwise(..._args: readonly unknown[]): unknown {
    return step4Unimplemented("window.walkwise");
  }
}
